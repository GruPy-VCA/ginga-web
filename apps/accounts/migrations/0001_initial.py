    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_portfolio_public', models.BooleanField(default=False, verbose_name='Portfolio is Public')),
                ('is_published', models.BooleanField(default=False, verbose_name='Is Published')),
                ('slug', models.SlugField(blank=True, unique=True, verbose_name='Slug', db_index=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('in_progress', 'In Progress'), ('completed', 'Completed'), ('dropped', 'Dropped'), ('on_hold', 'On Hold')], default='in_progress', max_length=20, verbose_name='Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project_type', models.CharField(choices=[('open_source', 'Open Source'), ('community', 'Community'), ('event', 'Event'), ('lecture', 'Lecture')], default='open_source', max_length=20, verbose_name='Type')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tech_projects', to='accounts.profile')),
            ],
            options={
